...
- The live pilot was driven by hand. There is still no opt-in automated live smoke test, so pilot regressions would only be caught by repeating the manual runbook.
